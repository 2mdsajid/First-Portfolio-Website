shellIntro = 'HTML Terminal created by sajid so call it salminal !<br><br>Type  --help<br><br>'
botIntro = "Welcome to BOT mode !!!<br>This is just a prototype with only few responses<br>You can type 'exit' to leave chat<br>You can start by hey,hi,intro etc<br><br>"
botExit = 'Bot mode exit!<br><br>'
...
//document.querySelector('.json').innerHTML = JSON.stringify(somDat)

//console.log('Welcome, This is a simple terminal using some html css');